...
namespace ProjectHoloWeb.Models
{
    ...
    partial void InsertAuthorKeyword(AuthorKeyword instance);
    partial void UpdateAuthorKeyword(AuthorKeyword instance);
    partial void DeleteAuthorKeyword(AuthorKeyword instance);
    ...
    partial void InsertComicKeyword(ComicKeyword instance);
    partial void UpdateComicKeyword(ComicKeyword instance);
    partial void DeleteComicKeyword(ComicKeyword instance);
    ...
    partial void InsertTeamKeyword(TeamKeyword instance);
    partial void UpdateTeamKeyword(TeamKeyword instance);
    partial void DeleteTeamKeyword(TeamKeyword instance);
    ...
    partial void DeleteAdmin(Admin instance);
		...
		public System.Data.Linq.Table<AuthorKeyword> AuthorKeywords
		{
			get
			{
				return this.GetTable<AuthorKeyword>();
			}
		}
		...
		public System.Data.Linq.Table<ComicKeyword> ComicKeywords
		{
			get
			{
				return this.GetTable<ComicKeyword>();
			}
		}
		...
		public System.Data.Linq.Table<TeamKeyword> TeamKeywords
		{
			get
			{
				return this.GetTable<TeamKeyword>();
			}
		}
	...
	public partial class Author : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AuthorKeyword> _AuthorKeywords;
    ...
    partial void OnupdatedChanged();
		...
		public Author()
		{
			this._AuthorKeywords = new EntitySet<AuthorKeyword>(new Action<AuthorKeyword>(this.attach_AuthorKeywords), new Action<AuthorKeyword>(this.detach_AuthorKeywords));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Author_AuthorKeyword", Storage="_AuthorKeywords", ThisKey="IDauthor", OtherKey="IDauthor")]
		public EntitySet<AuthorKeyword> AuthorKeywords
		{
			get
			{
				return this._AuthorKeywords;
			}
			set
			{
				this._AuthorKeywords.Assign(value);
			}
		}
		...
		private void attach_AuthorKeywords(AuthorKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Author = this;
		}
		
		private void detach_AuthorKeywords(AuthorKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Author = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AuthorKeyword")]
	public partial class AuthorKeyword : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDauthorChanging(string value);
    partial void OnIDauthorChanged();
    partial void OnIDkwChanging(string value);
    partial void OnIDkwChanged();
    #endregion
		
		public AuthorKeyword()
		{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDkw", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string IDkw
		{
			get
			{
			...
			set
			{
				if ((this._IDkw != value))
				{
					...
					this.OnIDkwChanging(value);
					this.SendPropertyChanging();
					this._IDkw = value;
					this.SendPropertyChanged("IDkw");
					this.OnIDkwChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Author_AuthorKeyword", Storage="_Author", ThisKey="IDauthor", OtherKey="IDauthor", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Author.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.AuthorKeywords.Remove(this);
					}
					this._Author.Entity = value;
					if ((value != null))
					{
						value.AuthorKeywords.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_AuthorKeyword", Storage="_Keyword", ThisKey="IDkw", OtherKey="IDkw", IsForeignKey=true)]
		public Keyword Keyword
		{
			...
			set
			{
							...
							|| (this._Keyword.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.AuthorKeywords.Add(this);
						this._IDkw = value.IDkw;
					}
					else
					{
						this._IDkw = default(string);
					}
	...
	public partial class Comic : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ComicKeyword> _ComicKeywords;
    ...
    partial void OnImageLinkChanged();
		...
		public Comic()
		{
			...
			this._ComicCatergories = new EntitySet<ComicCatergory>(new Action<ComicCatergory>(this.attach_ComicCatergories), new Action<ComicCatergory>(this.detach_ComicCatergories));
			this._ComicKeywords = new EntitySet<ComicKeyword>(new Action<ComicKeyword>(this.attach_ComicKeywords), new Action<ComicKeyword>(this.detach_ComicKeywords));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Comic_ComicKeyword", Storage="_ComicKeywords", ThisKey="IDcomic", OtherKey="IDcomic")]
		public EntitySet<ComicKeyword> ComicKeywords
		{
			get
			{
				return this._ComicKeywords;
			}
			set
			{
				this._ComicKeywords.Assign(value);
			}
		}
		...
		private void attach_ComicKeywords(ComicKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Comic = this;
		}
		
		private void detach_ComicKeywords(ComicKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Comic = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ComicKeyword")]
	public partial class ComicKeyword : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDcomicChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Comic_ComicKeyword", Storage="_Comic", ThisKey="IDcomic", OtherKey="IDcomic", IsForeignKey=true)]
		public Comic Comic
		{
			get
			{
			...
			set
			{
							...
							|| (this._Comic.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Comic.Entity = null;
						previousValue.ComicKeywords.Remove(this);
					}
					this._Comic.Entity = value;
					if ((value != null))
					{
						value.ComicKeywords.Add(this);
						this._IDcomic = value.IDcomic;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_ComicKeyword", Storage="_Keyword", ThisKey="IDkw", OtherKey="IDkw", IsForeignKey=true)]
		public Keyword Keyword
		{
			get
			{
	...
	public partial class Keyword : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<TeamKeyword> _TeamKeywords;
    ...
    partial void OnupdatedChanged();
		...
		public Keyword()
		{
			this._AuthorKeywords = new EntitySet<AuthorKeyword>(new Action<AuthorKeyword>(this.attach_AuthorKeywords), new Action<AuthorKeyword>(this.detach_AuthorKeywords));
			this._ComicKeywords = new EntitySet<ComicKeyword>(new Action<ComicKeyword>(this.attach_ComicKeywords), new Action<ComicKeyword>(this.detach_ComicKeywords));
			this._TeamKeywords = new EntitySet<TeamKeyword>(new Action<TeamKeyword>(this.attach_TeamKeywords), new Action<TeamKeyword>(this.detach_TeamKeywords));
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDkw", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string IDkw
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="keyword", Storage="_keyword1", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_AuthorKeyword", Storage="_AuthorKeywords", ThisKey="IDkw", OtherKey="IDkw")]
		public EntitySet<AuthorKeyword> AuthorKeywords
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_ComicKeyword", Storage="_ComicKeywords", ThisKey="IDkw", OtherKey="IDkw")]
		public EntitySet<ComicKeyword> ComicKeywords
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_TeamKeyword", Storage="_TeamKeywords", ThisKey="IDkw", OtherKey="IDkw")]
		public EntitySet<TeamKeyword> TeamKeywords
		{
			get
			{
				return this._TeamKeywords;
			}
			set
			{
				this._TeamKeywords.Assign(value);
			}
		}
		...
		private void attach_TeamKeywords(TeamKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Keyword = this;
		}
		
		private void detach_TeamKeywords(TeamKeyword entity)
		{
			this.SendPropertyChanging();
			entity.Keyword = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TeamKeyword")]
	public partial class TeamKeyword : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDteamChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Keyword_TeamKeyword", Storage="_Keyword", ThisKey="IDkw", OtherKey="IDkw", IsForeignKey=true)]
		public Keyword Keyword
		{
			get
			{
			...
			set
			{
							...
							|| (this._Keyword.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Keyword.Entity = null;
						previousValue.TeamKeywords.Remove(this);
					}
					this._Keyword.Entity = value;
					if ((value != null))
					{
						value.TeamKeywords.Add(this);
						this._IDkw = value.IDkw;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TransTeam_TeamKeyword", Storage="_TransTeam", ThisKey="IDteam", OtherKey="IDteam", IsForeignKey=true)]
		public TransTeam TransTeam
		{
			get
			{
    ...
    partial void OncreatedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TransTeam_TeamKeyword", Storage="_TeamKeywords", ThisKey="IDteam", OtherKey="IDteam")]
		public EntitySet<TeamKeyword> TeamKeywords
		{
			get
			{
